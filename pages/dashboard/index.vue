...
<template>
  <div>
    ...
    >
      <div class="max-w-7xl mx-auto bg-white p-5 mt-10 rounded-md">
        <h2 class="font-bold tracking-tighter text-2xl">
          ...
          <div class="body mt-5 space-y-5">
            ...
            <div class="space-y-4">
              ...
              <input
                ...
                placeholder="example url : https://google.com/search?=blabalalablablabalalbalalaalala"
                class="w-full p-2 rounded-md outline-none focus:bg-gray-100 bg-white border"
              />
            </div>
            <div class="space-y-4">
              <label for="title"
                >Your url shorten <span class="text-pink-500">*</span></label
              >
              <div
    ...
    <div class="grid grid-cols-3 gap-5 w-full mt-8 text-gray-800">
